...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <br />  
        ...
        <asp:Table runat="server" id="Table4" Width="100%" >
         <asp:TableRow ><asp:TableCell></asp:TableCell><asp:TableCell><dx:ASPxLabel ID="ASPxLabel21" runat="server" Font-Size="Large" Text="Results"> </dx:ASPxLabel></asp:TableCell></asp:TableRow>
         <asp:TableRow><asp:TableCell></asp:TableCell></asp:TableRow>
        <%-- Results --%>
        <asp:TableRow >
            <asp:TableCell  Width="10%"></asp:TableCell>
