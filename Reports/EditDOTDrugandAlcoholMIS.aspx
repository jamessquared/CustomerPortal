       ...
       <asp:TableRow>
            <asp:TableCell>
                  ...
                  <dx:ASPxGridView ID="gvDrugTestingData" runat="server" DataSourceID="dsDOTDrugandAlcoholMISDrugTestData" AutoGenerateColumns="False">
                      <TotalSummary>
                          <dx:ASPxSummaryItem DisplayFormat="Total" ShowInColumn="Type of Test" ValueDisplayFormat="Total" ShowInGroupFooterColumn="Type of Test" />
                          <dx:ASPxSummaryItem FieldName="TotalNoOfTestResults" ShowInColumn="Total Number of Test Results [Should equal the sum of Columns 2, 3, 9, 10, 11, and 12]" SummaryType="Sum" ShowInGroupFooterColumn="Total Number of Test Results [Should equal the sum of Columns 2, 3, 9, 10, 11, and 12]" />
                          <dx:ASPxSummaryItem FieldName="VerifiedNegativeResults" ShowInColumn="Verified Negative results" SummaryType="Sum" ShowInGroupFooterColumn="Verified Negative results" />
                          <dx:ASPxSummaryItem FieldName="VerifiedPostiveMoreThanOneDrug" ShowInColumn="Verified Positivie Results ~ For One or More Drugs" SummaryType="Sum" ShowInGroupFooterColumn="Verified Positivie Results ~ For One or More Drugs" />
                          <dx:ASPxSummaryItem FieldName="PositiveForMarijuana" ShowInColumn="Positive For Marijuana" SummaryType="Sum" ShowInGroupFooterColumn="Positive For Marijuana" />
                          <dx:ASPxSummaryItem FieldName="PositiveForCocaine" ShowInColumn="Positive for Cocaine" SummaryType="Sum" ShowInGroupFooterColumn="Positive for Cocaine" />
                          <dx:ASPxSummaryItem FieldName="PositiveForPCP" ShowInColumn="Positivie for PCP" SummaryType="Sum" ShowInGroupFooterColumn="Positivie for PCP" />
                          <dx:ASPxSummaryItem FieldName="PositiveForOpiates" ShowInColumn="Positive for Opiates" SummaryType="Sum" ShowInGroupFooterColumn="Positive for Opiates" />
                          <dx:ASPxSummaryItem FieldName="PositiveForAmphetamines" ShowInColumn="Positive for Amphetamines" SummaryType="Sum" ShowInGroupFooterColumn="Positive for Amphetamines" />
                          <dx:ASPxSummaryItem FieldName="RefusalResultsAdulterated" ShowInColumn="Adulterated" SummaryType="Sum" ShowInGroupFooterColumn="Adulterated" />
                          <dx:ASPxSummaryItem FieldName="RefusalResultsSustituted" ShowInColumn="Substituted" SummaryType="Sum" ShowInGroupFooterColumn="Substituted" />
                          <dx:ASPxSummaryItem FieldName="RefusalResultsShyBladderNoMedExplaination" ShowInColumn="Shy Bladder with No Medical Explanation" SummaryType="Sum" ShowInGroupFooterColumn="Shy Bladder with No Medical Explanation" />
                          <dx:ASPxSummaryItem FieldName="RefusalResultsOther" ShowInColumn="Other Refusals to Submit to Testing" SummaryType="Sum" ShowInGroupFooterColumn="Other Refusals to Submit to Testing" />
                          <dx:ASPxSummaryItem FieldName="CancelledResults" ShowInColumn="Cancelled Results" SummaryType="Sum" ShowInGroupFooterColumn="Cancelled Results" />
                      </TotalSummary>
                      <Columns>
                          <dx:GridViewDataTextColumn FieldName="TotalNoOfTestResults" Width="7.5%" Caption="Total Number of Test Results [Should equal the sum of Columns 2, 3, 9, 10, 11, and 12]" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="True"  VisibleIndex="1" ToolTip="This column requires a count of the total number of test results in each testing category during the entire reporting year. Count the number of test results as the number of testing events resulting in negative, positive, and refusal results. Do not count cancelled tests and blind specimens in this total.  [Example: A company that conducted fifty pre-employment tests would enter “50” on the PreEmployment row. If it conducted one hundred random tests, “100’ would be entered on the Random row. If that company did no post-accident, reasonable suspicion, reasonable cause, return-to-duty, or follow-up tests, those categories will be left blank or zeros entered.]">
                          ...
                          <dx:GridViewDataComboBoxColumn Caption="Type of Test" FieldName="TypeOfTest" VisibleIndex="0" Width="10%">
       ...
       <asp:TableRow>
           <asp:TableCell>
                  <dx:ASPxGridView ID="gvAlcoholTestingData" runat="server" DataSourceID="dsDOTDrugandAlcoholMISAlcoholTestData" AutoGenerateColumns="False" Width="90%">
                      <TotalSummary>
                          <dx:ASPxSummaryItem DisplayFormat="Total" ShowInColumn="Type of Test" ValueDisplayFormat="Total" />
                          <dx:ASPxSummaryItem FieldName="TotalNoOfTestResults" ShowInColumn="Total Number of Screening Test Results [Should equal the sum of Columns 2, 3, 7, and 8]" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="ResultsBelow02" ShowInColumn="Screening Tests with Results Below 0.02" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="Results02orGreater" ShowInColumn="Screening Tests with Results 0.02 or Greater" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="NoOfComfirmationTests" ShowInColumn="Number of Confirmation Tests results" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="ConfirmationTests02thru039" ShowInColumn="Confirmation Tests with Results 0.02 Through 0.039" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="ConfirmationTests04orGreater" ShowInColumn="Confirmation Tests with Results 0.04 or Greater" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="RefusalResultsShyLungNoMedExplaination" ShowInColumn="Shy Lung with No Medical Explanation" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="RefusalResultsOther" ShowInColumn="Other Refusals to Submit to Testing" SummaryType="Sum" />
                          <dx:ASPxSummaryItem FieldName="CancelledResults" ShowInColumn="Cancelled Results" SummaryType="Sum" />
                      </TotalSummary>
                      <Columns>
