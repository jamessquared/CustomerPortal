...
<%--   <div runat="server" style="overflow:auto; max-height:700px" >--%>
           <dx:ASPxDocumentViewer ID="rptDocViewer" runat="server" ClientInstanceName="clientDocViewer">
                            ...
                            <ToolbarItems>
                                <dx:ReportToolbarButton Text="Back"  ImageUrl="~/Images/Reports/Back Small.png" Name="btnBack" ToolTip="Returns to the main screen." />
				            ...
				            <ClientSideEvents ToolbarItemClick="function(s, e) {
				                   if(e.item.name == &quot;btnBack&quot;)
				                   {
                                        ...
                                        if (reportName.indexOf('=MIS') == -1)
                                        {
                                            document.location.href=&quot;../Default.aspx&quot;
                                        }
                                        else
                                        {
                                            document.location.href=&quot;../Reports/DOTDrugandAlcoholMISManagement.aspx&quot;
                                        }
				                   }
				                }" />
